// Taken from https://www.falukdevelop.com/2016/11/02/sdl2-controller-implementation/
...
bool InputController::Initialize(void)
{
    ...
    int iNumOfControllers = SDL_GameControllerAddMappingsFromFile("Input/gamecontrollerdb.txt");
